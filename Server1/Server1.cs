////////////////////////////////////////////////////////////////////////////
//  server1.cs  - the core of server1                                     //
//                                                                        //
//                                                                        //
//  ver 4.0                                                               //
...
Package Operations:
===================
The purpose of this module is to implement server 1
...
namespace Server1
{
    class Server1
    {
        ...
        void listen()
        {
            string endpoint = "http://localhost:4000/ICommunicator";
            try
            {
        ...
        //Sending chosen project analysis
        ...
        private void sendToS2()
        {
            string remoteAddress;
            remoteAddress = "http://localhost:4001/ICommunicator";
            sndr = new WCF.Sender(remoteAddress);
            Message tempMsg = new Message();
            tempMsg.content = relationXML.ToString();
        ...
        //merge localRelatonXML with the xml passed by server 2 into a global one for future analysis
        private void mergeXML(string otherXML)
        {
            ...
            child1.Add(localtypetableType);
            child1.Add(localtypetableRelation);
            root.Add(child1);
            XElement child2 = new XElement("Server2");
            child2.Add(remotetypetableType);
            child2.Add(remotetypetableRelation);
            root.Add(child2);
            GlobalXML.Save(@".\\GlobalRelationship.xml");
        ...
        //Server 1 will start at the beginning of the program.
