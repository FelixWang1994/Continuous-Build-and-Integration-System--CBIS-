...
//  Soruce Author:       Neethu Haneesha Bingi,                                  //
...
====================
ver 1.1 - 19 Nov 2014
- delete some display and change some attributes
ver 1.0 - 02 Oct 2014
- first release
*/
    ...
    public class XMLWriter
    {
        ...
        public void addFileTypesAndFunctions(List<FileTypesInfo> fileTypesInfo, bool showFuncSizeComp)
        {
            ...
            foreach (FileTypesInfo file in fileTypesInfo)
            {
                ...
                {
                    XElement type = new XElement("Type", new XAttribute("type", e.type), new XAttribute("name", e.name));
                    types.Add(type);
                }
