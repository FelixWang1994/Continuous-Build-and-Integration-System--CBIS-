 ...
 * --------------------
 * ver 2.4 : 19 Nov 2014
 * - add a new rule for buildRelsParser that can have an argument of list<Elem> thus change the repository.
 * ver 2.3 : 28 Sep 2014
...
namespace CodeAnalysis
{
  ...
  public class Repository
  {
    ...
    public Repository(List<Elem> local)
    {
        locations_ = local;
    }
  ...
  public class BuildCodeAnalyzer
  {
    ...
    //----< buils and returns parser for finding gloabal type relationships >----------
    public virtual Parser buildRelsParser(List<Elem> global)
    {
        Parser parser = new Parser();

        repo.locations = global;
